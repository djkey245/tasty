        ...
        <div class="main__container">
            ...
            <div class="cas__slider">
                ...
                <div class="cas__slider_header">
                    <a href="/" class="cas__slider_header_back"><p>Back</p></a>

                    <p class="ttl48">{{$case->title}}</p>
                </div>
                ...
                <div class="cas__slider_01" style="">
                    <div class="cas-slider">
                            ...
                            @foreach($feed as $drop)
                                <div class="cas__slider_main_cont" style="">
                                    <div class="cas__slider_main_block {{$drop->color}}">
                                        ...
                                        <img class="item" src="/img/item01.svg" alt="tasty case item">
                                        @include('layout.skin-block.name', ['name' => $drop->title])
                                    </div>
                                </div>
                            @endforeach
                        ...
                        <img class="cas__slider_main_frame01" style="bottom: calc(100% - 22px);"
                             src="/img/cases_frame01.png" alt="">
                        <img class="cas__slider_main_frame02" style="top: calc(100% - 22px);"
                             src="/img/cases_frame02.png" alt="">
                    ...
                    <div class="cas__slider_bottom">
                        <p>$ <span>{{number_format($case->price, 2)}}</span></p>
            ...
            <div class="cas__cases">
                <p class="ttl35">Contents in Case {{$randomSmile}}</p>
            ...
            */
            ...
            function openCase() {
                ...
                $.ajax({
                    ...
                    data: {'case': "{{$case->id}}", 'boost': boost, locale:'{{app()->getLocale()}}'},
                    success: function (resp) {
                        ...
                        if (resp.success) {
                            ...
                            */
                            ...
                            $('.header__top_account_health span').html(resp.hearts);
                            ...
                            $('div.cas__slider_main')
                                .transition({x: '-' + leftPosition + 'px'}, fastOpen, 'cubic-bezier(.31,.9985,.31,.9985)', function () {
                                    ...
                                    $("#win_first_case").removeAttr('class');
                                    $("#win_first_case").addClass('skinblock ' + resp.success.color);
                                    if (resp.success.title.indexOf('|') !== -1) {
